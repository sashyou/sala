...
public:
   ...
   // add by zhanghong
    ...
    static const char KEY_TSPHOTOPROCESSMODE_HDR[];
    static const char KEY_TSVIDEOPROCESSMODE_HDRCHECKER[];
    ...
    static const char KEY_VISIDON_FACE_BEAUTY_SKIN_TONE[];
    static const char KEY_VISIDON_FACE_BEAUTY_SKIN_SMOOTHING[];
    static const char KEY_VISIDON_FACE_BEAUTY_SKIN_COLOR[];
    static const char KEY_VISIDON_EYE_BRIGHTENING[];
#endif
    ...
    int32_t getStopDisplay(); //add by zhanghong
    ...
    uint32_t getZoomRatio() const;
    void     clearVisidonPara(void);
    int32_t  getPreVisidonMode();
    int32_t  getVisidonMode();
    int32_t  getVisidonFaceBeautyPara(cam_visidon_face_beauty_para para);
#endif
#ifdef TCT_TARGET_EIS_DXO_ENABLE
    int32_t setVideoEis(const QCameraParameters&);
    int32_t setVideoEis(const char *eis_status);
    bool isVideoEisEnable();
	bool mCameraId;
    int getCameraId();
    int32_t setCameraId(int camId);
#endif

private:
#ifdef TCT_VISIDON_FEATURE
    int32_t  setVisidonMode(const QCameraParameters & );
    int32_t  setVisidonFaceBeautyPara(const QCameraParameters & );
#endif
    ...
    int32_t setTestDualLEDvalue(const QCameraParameters& params); //add by zhanghong for test dual led 20151211
    int32_t setStopDisplay(const QCameraParameters& params); //add by zhanghong
...
#ifdef TCT_VISIDON_FEATURE
	int m_nPreVisidonMode;
	int m_nVisidonMode;
	int m_nSkinSmoothingLevel;
#endif
    ...
    int32_t m_stopDisplayFrame;    //add by zhanghong
    //add by zhanghong for test dual led 20151211
    int32_t m_TestDualLEDEnable;
    int32_t m_TestRLEDValue;
    int32_t m_TestBLEDValue;
